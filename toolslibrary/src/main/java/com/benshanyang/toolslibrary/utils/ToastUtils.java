...
public class ToastUtils {
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, ResUtils.getColor(context, R.color.toast_normal_color),
                ResUtils.getColor(context, R.color.toast_default_textcolor), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, ResUtils.getColor(context, R.color.toast_normal_color),
                ResUtils.getColor(context, R.color.toast_default_textcolor), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ResUtils.getDrawable(context, R.drawable.ic_error_outline),
                ResUtils.getColor(context, R.color.toast_warning_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ResUtils.getDrawable(context, R.drawable.ic_error_outline),
                ResUtils.getColor(context, R.color.toast_warning_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ResUtils.getDrawable(context, R.drawable.ic_info_outline),
                ResUtils.getColor(context, R.color.toast_info_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ResUtils.getDrawable(context, R.drawable.ic_info_outline),
                ResUtils.getColor(context, R.color.toast_info_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ResUtils.getDrawable(context, R.drawable.ic_right),
                ResUtils.getColor(context, R.color.toast_success_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ResUtils.getDrawable(context, R.drawable.ic_right),
                ResUtils.getColor(context, R.color.toast_success_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ResUtils.getDrawable(context, R.drawable.ic_error),
                ResUtils.getColor(context, R.color.toast_error_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ResUtils.getDrawable(context, R.drawable.ic_error),
                ResUtils.getColor(context, R.color.toast_error_color), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ResUtils.getColor(context, R.color.toast_default_textcolor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ResUtils.getDrawable(context, iconRes),
                ResUtils.getColor(context, tintColorRes), ResUtils.getColor(context, R.color.toast_default_textcolor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, @DrawableRes int iconRes,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, message, ResUtils.getDrawable(context, iconRes),
                ResUtils.getColor(context, tintColorRes), ResUtils.getColor(context, R.color.toast_default_textcolor),
                duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ResUtils.getColor(context, tintColorRes),
                ResUtils.getColor(context, R.color.toast_default_textcolor), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ResUtils.getColor(context, tintColorRes),
                ResUtils.getColor(context, textColorRes), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint) {
            drawableFrame = drawableFrame(context, tintColor);
        } else {
            drawableFrame = ResUtils.getDrawable(context, R.drawable.toasty_frame);
        }
    ...
    private static Drawable drawableFrame(@NonNull Context context, @ColorInt int tintColor) {
        return tintIcon(ResUtils.getDrawable(context, R.drawable.toasty_frame), tintColor);
    }
